...
public class OptionsSlider : Slider
{
    ...
    private ContainerRuntime _trackInstance;
    private NineSliceRuntime _middleBackground;
    /// <summary>
    ...
    public OptionsSlider(TextureAtlas atlas)
    {
        ...
        _middleBackground.Texture = middleBackgroundRegion.Texture;
        _middleBackground.TextureAddress = TextureAddress.Custom;
        _middleBackground.TextureHeight = middleBackgroundRegion.Height;
        _middleBackground.TextureLeft = middleBackgroundRegion.SourceRectangle.Left;
        _middleBackground.TextureTop = middleBackgroundRegion.SourceRectangle.Top;
        _middleBackground.TextureWidth = middleBackgroundRegion.Width;
        ...
        var thumbVisual = new ColoredRectangleRuntime();
        thumbVisual.Dock(Gum.Wireframe.Dock.Fill);
        thumbInstance.AddChild(thumbVisual);
        ...
        enabled.Apply = () =>
        {
            ...
            _middleBackground.Color = unfocusedColor;
            maxBackground.Color = unfocusedColor;
            _fillRectangle.Color = unfocusedColor;
            thumbVisual.Color = unfocusedColor;
        };
        ...
        focused.Apply = () =>
        {
            ...
            _middleBackground.Color = focusedColor;
            maxBackground.Color = focusedColor;
            _fillRectangle.Color = focusedColor;
            thumbVisual.Color = focusedColor;
        };
